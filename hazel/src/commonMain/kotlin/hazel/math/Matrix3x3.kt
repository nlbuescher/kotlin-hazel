...
class FloatMatrix3x3(
	...
	constructor(scalar: Float) : this(
		FloatVector3(scalar, 0f, 0f),
		FloatVector3(0f, scalar, 0f),
		FloatVector3(0f, 0f, scalar)
	)

	constructor() : this(1f)

	override fun get(row: Int): FloatVector3 = when (row) {
		0 -> row0; 1 -> row1; 2 -> row2
		else -> throw IndexOutOfBoundsException()
	}

	override fun set(row: Int, value: Vector3<Float>) {
		when (row) {
			0 -> row0 = value as FloatVector3
			1 -> row1 = value as FloatVector3
			2 -> row2 = value as FloatVector3
			else -> throw IndexOutOfBoundsException()
		}
	}

	override fun copy(): FloatMatrix3x3 = FloatMatrix3x3(this[0].copy(), this[1].copy(), this[2].copy())

	fun toFloatArray(): FloatArray = floatArrayOf(*this[0].asFloatArray(), *this[1].asFloatArray(), *this[2].asFloatArray())
	...
	override fun plus(scalar: Float): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] + scalar, this[1] + scalar, this[2] + scalar)
	}

	override fun minus(scalar: Float): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] - scalar, this[1] - scalar, this[2] - scalar)
	}

	override fun times(scalar: Float): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] * scalar, this[1] * scalar, this[2] * scalar)
	}

	override fun div(scalar: Float): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] / scalar, this[1] / scalar, this[2] / scalar)
	}
	...
	override fun plus(other: Matrix3x3<Float>): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] + other[0], this[1] + other[1], this[2] + other[2])
	}

	override fun minus(other: Matrix3x3<Float>): FloatMatrix3x3 {
		return FloatMatrix3x3(this[0] - other[0], this[1] - other[1], this[2] - other[2])
	}

	override fun times(other: Matrix3x3<Float>): FloatMatrix3x3 = FloatMatrix3x3(
	...
	override fun div(other: Matrix3x3<Float>): FloatMatrix3x3 {
		return this * other.inv()
	}


	override fun plusAssign(other: Matrix3x3<Float>) {
		this[0].plusAssign(other[0])
		this[1].plusAssign(other[1])
		this[2].plusAssign(other[2])
	}

	override fun minusAssign(other: Matrix3x3<Float>) {
	...
	override fun divAssign(other: Matrix3x3<Float>) {
		this *= other.inv()
	}
}
